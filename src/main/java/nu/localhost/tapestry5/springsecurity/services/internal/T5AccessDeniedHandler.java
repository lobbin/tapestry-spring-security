...
/**
 * Enables Tapestry to handle AccessDenied Exceptions. So you can 
 * show some additional information on your Page.
 * 
...
public class T5AccessDeniedHandler implements AccessDeniedHandler {
	...
	private static final Log logger = 
        LogFactory.getLog(T5AccessDeniedHandler.class);
	...
	throws IOException, ServletException {
        ...
        String redirectUrl = buildRedirectUrlToLoginPage(httpRequest, httpResponse, accessDeniedException);
